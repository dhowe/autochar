...
const WORD_TRIGGERS = ["臉書", "經濟", "对抗", "政治", "教会", "天主", "教徒", "信徒", "宗教", "文化", "和諧", "河蟹", "和谐", "專政", "伦理", "倫理", "诚实", "誠實", "公正", "正義", "野蛮", "野蠻", "利益", "皇帝", "傳教", "传教", "挑撥", "挑拨", "杯葛", "領土", "领土", "敏感", "市場", "占领", "佔領", "利润", "盈利", "領域", "领域", "极限", "極限", "穩定", "稳定", "文明", "干預", "干预", "罢工", "罷工", "階級", "统治", "統治", "隱私", "隐私", "取締", "取缔", "操纵", "操縱", "系统", "體系", "体系", "操控", "欺負", "欺凌", "欺负", "領導", "领导", "主導", "主导", "领袖", "領袖", "馴化", "驯化", "血统", "血統", "憤慨", "忠诚", "忠誠", "忠贞", "忠貞", "贡献", "貢獻", "效忠", "投票", "表决", "公投", "宣誓", "請願", "崩潰", "崩溃", "打倒", "治安", "公安", "禮儀", "礼仪", "否決", "否决", "惡搞", "書記", "獻花", "暗访", "暗杀", "罢教", "罢课", "罢市", "百姓", "败类", "绑架", "爆炸", "被捕", "笔会", "变态", "标语", "兵变", "冰毒", "部队", "部委", "采访", "惨案", "藏獨", "藏独", "藏文", "藏语", "草根", "铲除", "常委", "倡议", "城管", "澄清", "冲突", "抽插", "出卖", "出台", "出租", "传销", "打炮", "打砸", "代理", "弹劾", "荡妇", "倒台", "祷告", "悼念", "登基", "地震", "颠覆", "调查", "调教", "定性", "动乱", "动态", "毒杀", "对付", "对峙", "多維", "多维", "多黨", "夺权", "恶搞", "二奶", "法会", "法轮", "法輪", "法治", "翻牆", "翻墙", "放纵", "分裂", "愤青", "封杀", "富婆", "讣告", "妇联", "改朝", "肛交", "蛤蟆", "公诉", "广场", "龟公", "海外", "汉奸", "号召", "合法", "护法", "怀念", "皇储", "基督", "激情", "鸡奸", "集合", "集会", "集结", "集体", "计划", "纪念", "纪委", "加油", "驾崩", "奸污", "贱货", "交警", "揭秘", "禁食", "精液", "精英", "决策", "绝食", "军妓", "开苞", "开枪", "开斋", "抗议", "空难", "空難", "口号", "口交", "口號", "酷刑", "垮台", "蜡烛", "雷管", "冷战", "联署", "领馆", "流氓", "聲援", "露点", "律师", "乱伦", "轮奸", "沦陷", "论功", "论坛", "裸露", "裸照", "吗啡", "孟浪", "缅怀", "明天", "墓碑", "呐喊", "纳粹", "奴役", "陪酒", "彭博", "评论", "破鞋", "曝光", "谴责", "强奸", "清朝", "清明", "情妇", "情色", "群交", "热点", "热血", "儒教", "乳交", "瑞典", "骚货", "骚乱", "色狼", "色情", "色欲", "煽动", "上台", "少妇", "射精", "社论", "呻吟", "审查", "审核", "审理", "审判", "蕩婦", "圣战", "使馆", "收盘", "吮吸", "號召", "台獨", "台独", "台湾", "贪官", "谈判", "坦克", "讨伐", "特警", "特务", "统独", "统战", "推翻", "推特", "吞精", "脱光", "外挂", "外泄", "晚会", "汪洋", "维权", "维稳", "味精", "文凭", "喜讯", "洗牌", "下台", "下体", "下體", "献花", "宪法", "宪章", "宪政", "香港", "消魂", "消息", "邪恶", "邪教", "邪灵", "泄密", "信访", "行动", "性交", "性欲", "胸推", "胸罩", "血案", "血战", "讯息", "颜射", "艳舞", "异议", "阴部", "阴蒂", "阴户", "阴精", "阴谋", "游行", "诱惑", "冤案", "元老", "杂种", "早泄", "論功", "炸弹", "炸藥", "炸药", "真相", "震撼", "挣扎", "正念", "政策", "政权", "政协", "证词", "支持", "珠江", "烛光", "變態", "抓捕", "转化", "走光", "走私", "昨天", "作秀", "茉莉", "鎮壓", "陰蒂", "陰莖", "收费", "阳萎", "網址", "脫光", "鸡婆", "无码", "吸毒", "溜冰", "赌博", "艳照", "全活", "正法", "性伴", "煽情", "偷情", "猎枪", "零售", "治愈", "精准", "口爆", "咕噜", "聚会", "宇宙", "駐港", "罷教", "罷課", "罷市", "燭光", "繁星", "导弹", "仿真", "狗粮", "炮弹", "塑胶", "订购", "交换", "转让", "提供", "加工", "合成", "蔡锷", "李鹏", "纽时", "双开", "双规", "上证", "政变", "叶城", "阿坝", "博讯", "韩正", "喀什", "军委", "胡佳", "江青", "吴仪", "郭泉", "紫阳", "上访", "妈的", "喇嘛", "時代", "革命", "光復", "送中", "港獨", "林鄭", "榮光", "元朗", "警暴", "國安", "之鋒", "催淚", "示威", "白紙", "武肺", "文亮", "蘋果", "智英", "安生", "柱銘", "維尼", "自決", "巨流", "恐襲", "威脅", "勾結", "維護", "安全", "罪行", "顛覆", "政權", "恐怖", "境外", "規定", "管轄", "法律", "準確", "懲治", "組織", "犯罪", "保障", "權益", "決定", "權利", "責任", "依法", "保護", "公約", "出版", "堅持", "定罪", "假定", "被告", "訴訟", "審判", "主權", "義務", "公職", "確認", "擁護", "法規", "執法", "執行", "媒體", "網絡", "宣傳", "指導", "管理", "守法", "意識", "負責", "政務", "財政", "保安", "分析", "研判", "規劃", "協調", "行動", "干涉", "信息", "覆核", "保守", "秘密", "任務", "收集", "部署", "調查", "罪案", "審查", "檢控", "批准", "核准", "策劃", "破壞", "分離", "改變", "徒刑", "拘役", "煽動", "教唆", "物資", "干擾", "阻撓", "攻擊", "正常", "實現", "主張", "放毒", "放射", "傳染", "設施", "系統", "危險", "公私", "宣揚", "主義", "影響", "凍結", "收買", "指使", "支援", "憎恨", "暫停", "吊銷", "收益", "投案", "如實", "查證", "偵破", "出境", "法院", "判決", "聲明", "議員", "官員", "法官", "法定", "偵查", "保釋", "公訴", "審理", "相信", "搜查", "證據", "涉嫌", "充公", "移除", "合理", "督責", "授權", "細則", "上訴", "終審", "證明", "戰略", "外交", "部隊", "檢察", "拘捕", "作證", "檢查", "扣押", "妨礙", "保密", "脅迫", "危害", "刺探", "串謀"];
